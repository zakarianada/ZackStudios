...
export function ContactSection({ sectionNumber = 5 }: { sectionNumber?: number }) {
  ...
  return (
    <section id="contact" className="relative overflow-hidden border-t border-white/8 py-24 md:py-32">
      ...
      <div className="mx-auto grid max-w-[1500px] gap-10 px-5 md:px-9 lg:grid-cols-[.75fr_1.25fr]">
        <div>
          <p className="text-[10px] font-semibold uppercase tracking-[.2em] text-[#ff3439]">0{sectionNumber} / Start a project</p>
        ...
        <form onSubmit={submit} className="relative rounded-2xl border border-white/10 bg-[#0d0d0e] p-5 md:p-7">
          ...
          <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <p role="status" className={`text-xs ${state === "error" ? "text-red-400" : "text-white/45"}`}>{message || "Share a few details. I’ll take it from there."}</p>
